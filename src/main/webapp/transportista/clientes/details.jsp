<%-- 
    Document   : details
    Created on : 9 nov. 2024, 22:31:23
    Author     : Usuario
--%>
...
<div  class="text-black max-w-[35rem] my-6 flex gap-y-4  flex-col xs:flex-row  flex-wrap w-full">
    ...
    <div class="flex flex-col xs:flex-row w-full gap-4 justify-between">
        <a  href="/transportista?pagina=clientes"   class="text-white hover:bg-blue-800 cursor-pointer transition-all duration-500 bg-blue-600 
