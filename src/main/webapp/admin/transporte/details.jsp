...
<h1 class="text-black text-4xl font-bold">Detalles de Transporte</h1>
...
<div  class="text-black max-w-[35rem] my-6 flex gap-y-4  flex-col xs:flex-row  flex-wrap w-full">
    ...
    <div class="flex flex-col xs:flex-row w-full gap-4 justify-between">
        <a  href="/admin?pagina=transporte"   class="text-white hover:bg-blue-800 cursor-pointer transition-all duration-500 bg-blue-600 
