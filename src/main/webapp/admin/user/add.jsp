...
<h1 class="text-black text-4xl font-bold">Agregar Empleado</h1>

<form action="/Usuarios/add" method="post" class="max-w-[50rem] bg-trasparent text-black my-6 flex gap-y-4  md:gap-y-6 flex-col xs:flex-row  flex-wrap w-full">
    ...
    <div class="flex flex-col gap-y-4 md:gap-y-6 w-full md:w-2/4  ">
        ...
        <div class="flex flex-col xs:flex-row gap-0.5 justify-between xs:items-center  w-full ">
            <label for="cpass" class="sm:text-lg font-medium xs:w-2/4 sm:w-2/5">Contraseña:</label>
            <input id="cpass" name="password" type="text" class="bg-transparent outline-none 
                   px-2 py-1 pr-4 font-sans w-full border  border-secondary-300 rounded-md " value="">
        </div> 
        <div class="flex flex-col xs:flex-row gap-0.5  justify-between xs:items-center  w-full  ">
        ...
        <div class="flex flex-col xs:flex-row gap-0.5 justify-between xs:items-center w-full">
            <label for="crol" class="sm:text-lg font-medium xs:w-2/4 sm:w-2/5">Rol:</label>
            <select id="crol" name="rol" class="bg-transparent outline-none px-2 py-1 pr-4 font-sans w-full border border-secondary-300 rounded-md">
    ...
    <div class="flex flex-col xs:flex-row w-full gap-4 justify-evenly">
        <a  href="/admin?pagina=usuario" class="hover:bg-red-800 cursor-pointer transition-all duration-500 bg-red-600 
